...
namespace SliceTester.Classes
{
    public class Mouse
    {
        ...
        // Botão esquerdo.
        private const int MOUSEEVENTF_LEFTDOWN = 0x0002; // simula pressionar BotãoEsquerdo.
        private const int MOUSEEVENTF_LEFTUP = 0x0004; // simula pressionar BotãoDireito.
        // Botão do meio.
        private const int MOUSEEVENTF_MIDDLEDOWN = 0x0020; // simula pressionar BotãoMeio.
        private const int MOUSEEVENTF_MIDDLEUP = 0x0040; // simula soltar BotãoMeio.
        // Rodela do meio.
        private const int MOUSEEVENTF_WHEELV = 0x0800; // simula rolar a roda do mouse verticalmente.
        private const int MOUSEEVENTF_WHEELH = 0x01000; // simula rolar a roda do mouse horizontalmente.
        // Botão direito.
        private const int MOUSEEVENTF_RIGHTDOWN = 0x0008; // simula pressionar BotãoDireito.
        private const int MOUSEEVENTF_RIGHTUP = 0x0010; // simula soltar BotãoDireito.
        ...
        public void ScrollVertical(int delta)
        {
            ...
            mouse_event(MOUSEEVENTF_WHEELV, 0, 0, delta, IntPtr.Zero);
        ...
        public void ScrollHorizontal(int delta)
        {
            ...
            mouse_event(MOUSEEVENTF_WHEELH, 0, 0, delta, IntPtr.Zero);
            Console.WriteLine($"Roda do mouse girada com valor {delta}.");
